(() => {
  ...
  function previewSurvey(s){
    ...
    modal(`Voorbeeld voor vereniging · ${s.title}`,`<div class="survey-preview-tabs"><button class="primary" data-preview-tab="mail">Uitnodigingsmail</button><button class="secondary" data-preview-tab="form">Invulformulier</button></div><div id="surveyPreviewMail">${email}</div><div id="surveyPreviewForm" hidden>${form}</div>`);
